...
\begin{figure}[!h]
    \center
    \includegraphics[scale=0.5]{autoencoder_general.png}
...
\begin{figure}[!h]
    \center
    \includegraphics[scale=0.5]{autoencoder_stochastic.png}
...
\begin{figure}[!h]
    \center
    \includegraphics[scale=0.5]{autoencoder_rbm.png}
...
\begin{figure}[!h]
    \center
    \includegraphics[scale=0.5]{autoencoder_deepbelief.png}
